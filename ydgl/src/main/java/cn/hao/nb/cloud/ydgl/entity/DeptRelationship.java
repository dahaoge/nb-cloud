...
@TableName("ydgl_dept_relationship")
@ApiModel(value = "DeptRelationship对象", description = "用电管理组织机构对照表 ")
public class DeptRelationship implements Serializable {


    public static SearchParams getSearchParamInstance() {
        return new DeptRelationship().new SearchParams();
    }
    ...
    public class SearchParams {
        ...
        private String sort = DeptRelationship.UPDATE_TIME;

        @ApiModelProperty(value = "排序方式,可选值:ASC/DESC")
        private ESqlOrder order = ESqlOrder.DESC;

        public Qw<DeptRelationship> preWrapper(Qw<DeptRelationship> qw) {
    ...
    @ApiModelProperty(value = "本地组织机构id")
    ...
    public static final String LOCAL_DEPT_ID = "local_dept_id";

    public static final String OUT_DEPT_ID = "out_dept_id";
